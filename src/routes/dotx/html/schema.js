 ...
 */
const dotxToHtmlPostSchema = {
	tags,
	summary: "Convert DOTX to HTML",
	description:
		"Returns the result of converting a DOTX document to HTML format.",
	operationId: "postDotxToHtml",
	consumes: [
...
module.exports = { dotxToHtmlPostSchema };
